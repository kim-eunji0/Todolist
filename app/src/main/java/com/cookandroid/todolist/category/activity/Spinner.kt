...
import com.cookandroid.todolist.databinding.ActivityContentTodolistBinding

class Spinner : AppCompatActivity() {
    // 카테고리 선택 spinner
    private lateinit var binding : ActivityContentTodolistBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityContentTodolistBinding.inflate(layoutInflater)
